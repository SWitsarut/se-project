...
export const POST = async (req: Request) => {
  ...
  if(!isValidString(username) || !isValidString(displayName)) {
    return NextResponse.json({ error: "Username and Display Name must not contain special characters" }, { status: 400 });
  }
